...
import com.github.faizalzafri.rebalancing.model.TaxLotDto;
...
public class PortfolioController {
    ...
    public Map<String, Object> executeTradeSuggestion(@PathVariable("id") Long id) {
        ...
        // 3. Post transaction to ledger in portfolio-ledger-service (BUY or SELL) using Feign
        ...
        log.info("Posting executed transaction to portfolio-ledger-service ledger: {}", txnRequest);
